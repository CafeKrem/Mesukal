...
## suppose that first packet include reception port 


pre_name = "./vecteurs/P1201_LR_TV"+trace+".pre"
...
print "video resoultion: ", bvp.videoResolution
...
pcap_name = "./vecteurs/P1201_LR_TV"+trace+".pcap"
...
print v_tsm, "clock rate:", v_cr, "tvf:", v_nts, "v_mt: ", v_mt
...
print "number of I-Frame", NIF, "TIFB:", TIFB, "AIBF:", ABIF, "NDF:", NDF
...
print "bit rate:", BR, "Normlized bitrate: ", NBR, "AIRF", AIRF, "IR ratio:", IRatio, "CCF:", CCF, "PLEF:", PLEF 
...
print "Degradation compression", DC, "MOS compression:", MOSC
...
print "Degradation Packet Loss:", DP, "MOSP:", MOSP
...
print "NRE:", NRE, "ARL:", ARL, "MREFE:", MREEF, "DR:", DR, "MOSR:", MOSR
